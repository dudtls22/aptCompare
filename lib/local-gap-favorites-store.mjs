...
export async function listLocalGapFavoriteScopes() {
  try {
...
export async function readSharedLocalGapFavorites() {
  return readLocalGapFavorites(SHARED_SCOPE);
}

export async function writeSharedLocalGapFavorites(list) {
  return writeLocalGapFavorites(SHARED_SCOPE, list);
}
